...
const CreatePaper = () => {
  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", padding: "20px", textAlign: "center", background: "#e3e8f0", minHeight: "100vh" }}>
      <a href="/" style={{ textDecoration: "none", color: "#890f50", fontWeight: "bold", fontSize: "18px", display: "inline-block", borderRadius: "20px", padding: "10px", marginRight: "100%", cursor: "pointer", transition: "color 0.3s ease" }}>
        &#129092; Back
      </a>
